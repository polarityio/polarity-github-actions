...
const { split, flow, map, trim, size, compact } = require('lodash/fp');
...
const main = async () => {
  try {
    ...
    const actionFileNames = getNewLineStringInput('action_file_names');
    const repoNamesForTesting = getNewLineStringInput('repository_names_for_testing');
